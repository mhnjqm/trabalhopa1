...
<html>
    ...
    <body>
        ...
        <div id="divMedidoresCadastrados">
            ...
            <h4><a href='?nomeDoTratadorDePagina=mvc.Tratador_pagina2_jsp&action=editCadastrar' style="color:#0044ff">Cadastrar novo medidor</a></h4>
            ...
            <table id="tabelamedidores">
                ...
                <% if (request.getSession().getAttribute("cadastrar_medidor") == "1") { %>
                    <form id="CadastroMedidorForm" method="POST" action="controller">
                        <input type="hidden"
                        ...
                        <tr>
                            ...
                            <td>
                                !-- BOTÃO CADASTRAR (mostrar campos editáveis) -->
                                <a href="#" onclick="submitForm('CadastroMedidorForm');"> Cadastrar</a>


                                <!-- BOTÃO CANCELAR CADASTRO (volta pro botão Cadastrar) -->

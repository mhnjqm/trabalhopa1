...
public class Controller extends HttpServlet {
    ...
    protected void processRequest(  HttpServletRequest request,
        ...
        try {
            ...
            if (nomeDoTratadorDePagina == null)  nomeDoTratadorDePagina = "mvc.pagehandlers.Tratador_pagina1_jsp" ;
                
            tratador = (IFTratadorDePaginas) Class.forName(nomeDoTratadorDePagina).newInstance();
            System.out.println("DEPOIS DO TRATADOR " +nomeDoTratadorDePagina);
